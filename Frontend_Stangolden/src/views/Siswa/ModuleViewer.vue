      ...
      <main class="p-6 max-w-5xl w-full mx-auto space-y-6">
        ...
        <div v-else-if="!module" class="bg-white p-6 rounded shadow text-center text-slate-500">
          ...
          <ul class="text-sm text-slate-500 list-disc list-inside text-left max-w-xl mx-auto mb-4">
            ...
            <li>Pastikan router memiliki route yang cocok dengan URL (contoh: <code>/modul/content/:id</code> atau <code>/modul/:slug</code>).</li>
          </ul>
          ...
          <div class="mt-4">
            <router-link to="/modul" class="inline-block px-4 py-2 bg-sky-600 text-white rounded">Kembali ke daftar modul</router-link>
          </div>
        </div>
